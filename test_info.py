...
from PyQt5.QtWidgets import (QApplication, QColorDialog, QFileDialog, QLineEdit, QMainWindow, QVBoxLayout, 
...
class UIFunction(TestWindow):
    ...
    def connect(self, ui):
        ...
        ui.Test_btn.setStyleSheet("""QPushButton {
    ...
    def changed(self, ui, k):
        if k == 0:
            ...
            ui.Info_btn.setStyleSheet("""QPushButton {
